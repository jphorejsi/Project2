...
class Camera
{
  Camera()
  {
    position      = new PVector( 290.33543, 196.55952, 303.83252 ); // initial position
    theta         = 0.5494994; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.73777926; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
